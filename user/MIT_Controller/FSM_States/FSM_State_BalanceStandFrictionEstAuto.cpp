 ...
 * Balance controller (FrictionEstAuto) for the incremental instantaneous balance control.
 */

#include "FSM_State_BalanceStandFrictionEstAuto.h"
 ...
 */
template <typename T>
FSM_State_BalanceStandFrictionEstAuto<T>::FSM_State_BalanceStandFrictionEstAuto(
    ControlFSMData<T>* _controlFSMData)
    : FSM_State<T>(_controlFSMData, FSM_StateName::BALANCE_STAND_FRICTION_EST_AUTO,"BALANCE_STAND_FRICTION_EST_AUTO") {
...
template <typename T>
void FSM_State_BalanceStandFrictionEstAuto<T>::onEnter() {
 ...
 */
template <typename T>
FSM_StateName FSM_State_BalanceStandFrictionEstAuto<T>::checkTransition() {
  // Get the next state
  _iter++;
  ...
  switch ((int)this->_data->controlParameters->control_mode) {
    ...
    default:
      std::cout << "[CONTROL FSM] Bad Request: Cannot transition from "
                << K_BALANCE_STAND_FRICTION_EST_AUTO << " to "
 ...
 */
template <typename T>
TransitionData<T> FSM_State_BalanceStandFrictionEstAuto<T>::transition() {
  // Switch FSM control mode
 ...
 */
template <typename T>
void FSM_State_BalanceStandFrictionEstAuto<T>::onExit() {
  _iter = 0;
}
 ...
 */
template <typename T>
void FSM_State_BalanceStandFrictionEstAuto<T>::BalanceStandFrictionEstAutoStep() {
...
template class FSM_State_BalanceStandFrictionEstAuto<float>;
